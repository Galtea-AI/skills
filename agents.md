...
| [`galtea-loop`](./skills/galtea-loop/) | Orchestrate the end-to-end Galtea improvement loop for an AI product: define specs, generate tests, evaluate, iterate. Vendor-neutral; composes the `galtea` skill for CLI/SDK mechanics. |
